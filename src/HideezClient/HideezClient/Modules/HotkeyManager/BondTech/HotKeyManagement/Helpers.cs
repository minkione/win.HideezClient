...
namespace HideezClient.Modules.HotkeyManager.BondTech.HotKeyManagement
{
    public static class HotKeyShared
    {
        ...
        public static void ParseShortcut(string text, out ModifierKeys modifier, out Keys key)
        {
            var res = ParseShortcut(text);
            modifier = (ModifierKeys)res.GetValue(0);
            key = (Keys)res.GetValue(1);
        }
